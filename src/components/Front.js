    ...
    <>
      ...
      >
          ...
          {selectedItem && (
            ...
            >
              <Box sx={{ flex: 1, marginBottom: { xs: "20px", sm: "0" } }}>
                <Typography variant="h6" sx={{ fontWeight: "bold", marginBottom: "8px", color: "#FF7E5F" }}>
                  {selectedItem.title}
                </Typography>
        ...
        >
          ...
          >
            Want to make your Business Online?
          </Typography>
          <Button
            sx={{
              backgroundColor: "#FF645A",
              transform: "scale(1.05)",
              boxShadow: "0px 4px 14px rgba(255, 94, 74, 0.4)",
              color: "#fff",
              fontWeight: "600",
              textTransform: "none",
              borderRadius: "8px",
        ...
        <>
          ...
          <Box sx={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
            <Box sx={{ width: "80%", maxWidth: "800px", display: "flex", justifyContent: "center" }}>
              <Image
                src={data[currentIndex]?.url || "/placeholder.jpg"}
